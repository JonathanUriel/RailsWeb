...
ActiveRecord::Schema.define(version: 20160809171412) do
  ...
  add_index "relevants", ["product_id"], name: "index_relevants_on_product_id", using: :btree
  ...
  add_foreign_key "relevants", "products"
end
